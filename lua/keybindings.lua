...
map("n", "<F5>", ":!clear && clang++ -O2 -std=c++17 %:p -o %:p:r && %:p:r<CR>", opt)
map("n", "<F6>", ":!clear && clang++ -O2 -std=c++17 %:p -o :r && :h/:r<:p:h/in<CR>", opt)
...
-- Material 设置
map("n", "<leader>kt",":lua require('material.functions').find_style()<CR>", opt)
