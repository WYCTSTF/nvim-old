...
map("n", "<F5>", ":!clang++ -O2 -std=c++17 -fsanitize=address -I ~/solution/header %:p -o %:p:r && %:p:r<CR>", opt)
map("n", "<F6>", ":!clang++ -O2 -std=c++17 -fsanitize=address -I ~/solution/header %:p -o %:p:r && %:p:r < %:p:h/in <CR>", opt)
